  ...
  return (
    <section className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-12">
      ...
      <div>
        ...
        <div className="mb-2">
          I like to explore new tech and always curious to play with new languages and bult stuffa round them , for now playing with  <span className="font-semibold">JavaScript, React, Tailwind, Node.js</span>. 
          <br />
