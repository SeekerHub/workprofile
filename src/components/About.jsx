...
export default function About() {
  return (
    <section className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-12">
      ...
      <div>
        <div className="text-xl mb-2 leading-8">
          I am a Software Developer, I have experience in building scalable, secure and reliable web applications using various frameworks and technologies. I enjoy solving complex problems and learning new skills. I am passionate about creating high-quality code that follows best practices and industry standards. I am always looking for new challenges and opportunities to grow as a developer.
        </div>
        {/* <div className="text-xl mb-2 leading-8">
          I like to explore new tech and always curious to play with new languages and build stuff around them , for now playing with  <span className="font-semibold">JavaScript, ES6+, React, Tailwind, Node.js, React Native, C3, .....</span>. 
          <br />
